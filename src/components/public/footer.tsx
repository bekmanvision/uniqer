...
const footerLinks = {
  tours: [
    ...
    { name: 'Алматы', href: '/tours?city=Алматы' },
    { name: 'Астана', href: '/tours?city=Астана' },
  ],
  info: [
    { name: 'Университеты', href: '/universities' },
    { name: 'Программы', href: '/programs' },
    { name: 'Для школ', href: '/for-schools' },
  ],
  company: [
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-gray-600">
              Кампус-туры по лучшим университетам Казахстана. Помогаем школьникам сделать осознанный
          ...
          {/* Tours */}
          <div>
            <h3 className="font-semibold text-gray-900">Туры</h3>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-center text-sm text-gray-500">
            © {new Date().getFullYear()} UniQer. Все права защищены.
          </p>
        </div>
      </div>
    </footer>
