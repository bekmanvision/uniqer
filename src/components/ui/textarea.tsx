    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ...
          id={id}
          className={cn(
            'w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 placeholder-gray-400 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-500',
