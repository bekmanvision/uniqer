...
export async function generateMetadata({ params }: UniversityPageProps) {
  ...
  if (!university) {
    return { title: t('universityNotFound') }
  }
...
export default async function UniversityPage({ params }: UniversityPageProps) {
  ...
  const tut = await getTranslations('universityTypes')
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="bg-white dark:bg-gray-900 border-b dark:border-gray-800">
        <div className="mx-auto max-w-6xl px-4 py-8 lg:px-8 lg:py-12">
          ...
          <Link
            href="/universities"
            className="mb-6 inline-flex items-center text-sm text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
          >
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
            <div className="flex items-start gap-5">
              <div className="flex h-16 w-16 lg:h-20 lg:w-20 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 border border-blue-100 dark:border-blue-800">
              ...
              <div>
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  <Badge variant={
                    ...
                    {tut(university.type as 'STATE' | 'PRIVATE' | 'AUTONOMOUS' | 'BRANCH')}
                  </Badge>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card>
              <CardContent className="p-6 lg:p-8">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">{t('aboutUniversity')}</h2>
                ...
                {university.features && university.features.length > 0 && (
                  <div className="mt-6 pt-6 border-t dark:border-gray-700">
                    <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">{t('features')}</h3>
              ...
              <Card className="border-2 border-green-100 dark:border-green-800">
                <CardContent className="p-6 lg:p-8">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{t('whoFits')}</h2>
                  </div>
            ...
            <Card>
              <CardContent className="p-6 lg:p-8">
                  ...
                  <div className="flex items-baseline gap-2 mb-3">
                    ...
                    {university.tuitionMax && university.tuitionMax !== university.tuitionMin && (
                      <span className="text-sm text-gray-500 dark:text-gray-400">
                        {tc('to')} {formatPrice(university.tuitionMax, locale)}
                      </span>
                    )}
                  </div>
                ) : (
                ...
                {/* Grant info */}
                {university.grants && (
                  <div className="flex items-center gap-2 rounded-lg bg-green-50 dark:bg-green-900/30 p-3 mt-3">
                ...
                {university.tuitionNote && (
                  <p className="text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800/50 rounded-lg p-3 mt-3">
                    {university.tuitionNote}
                  </p>
                )}
              </CardContent>
              ...
              <Card>
                <CardContent className="p-6 lg:p-8">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{t('participatesInTours')}</h2>
                  </div>
                  <div className="space-y-3">
                    {university.tours.map(({ tour }) => (
                      <Link
                        ...
                        className="flex items-center justify-between p-4 rounded-xl border border-gray-100 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-700 hover:bg-blue-50/50 dark:hover:bg-blue-900/20 transition-all group"
                      >
                        <div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-4">{t('information')}</h3>
                <div className="space-y-4">
                  ...
                  {university.ranking && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{university.ranking}</p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 dark:text-gray-400">{tc('grants')}</p>
                      <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
                        {university.grants ? t('grantsAvailable') : t('noInfo')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
                        {university.hasDormitory ? t('has') : t('noInfo')}
                      </p>
                    </div>
                  </div>
                  ...
                  {university.hasMilitary && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs text-gray-500 dark:text-gray-400">{tc('militaryDept')}</p>
                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{t('has')}</p>
                      </div>
                    </div>
                  )}
                </div>
            ...
            {(university.address || university.phone || university.email) && (
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-4">{t('contacts')}</h3>
                  <div className="space-y-4">
                    {university.address && (
                      <div className="flex items-start gap-3">
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-100 dark:bg-gray-800 flex-shrink-0">
                          <MapPin className="h-4 w-4 text-gray-600 dark:text-gray-400" />
                        </div>
                        <div>
                          <p className="text-xs text-gray-500 dark:text-gray-400">{t('address')}</p>
                          <p className="text-sm text-gray-900 dark:text-gray-100">{university.address}</p>
                        </div>
                      </div>
                    )}
            ...
            <Card className="bg-gradient-to-br from-blue-600 to-blue-700 border-0">
              <CardContent className="p-6 text-center">
                <h3 className="font-semibold text-white mb-2">{t('wantToVisit')}</h3>
